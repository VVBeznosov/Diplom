...
//	++ ВКМ движение по регистру ВКМ_ОбслуживаниеКлиентов
	
	Если Услуги.Количество() = 0 Тогда
		Возврат;
	КонецЕсли; 
	
	Движения.ВКМ_ОбслуживаниеКлиентов.Записывать = Истина;
	...
	Для Каждого ТекСтрокаУслуги Из Услуги Цикл
		Если ТекСтрокаУслуги.Номенклатура = Абонплата Или 
				ТекСтрокаУслуги.Номенклатура = Почасовка Тогда
			Движение = Движения.ВКМ_ОбслуживаниеКлиентов.Добавить();
			Движение.Период = Дата;
			Движение.Контрагент = Контрагент;
